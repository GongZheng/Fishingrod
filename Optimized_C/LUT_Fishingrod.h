...
#  define PUTU32(ct, st) { (ct)[0] = (u8)((st)); (ct)[1] = (u8)((st) >> 8); (ct)[2] = (u8)((st) >>  16); (ct)[3] = (u8)((st)>>24); }
...
void fishingrod_encrypt_rounds(const uint8_t *plain, const uint8_t *key, uint8_t *cipher)
{
    const u32 *rk;
